...
//Bot settings
var settings = {
  token: "xoxb-278894589312-mwNEeMi597LbCQJPngTHnbWl", // Add a bot https://my.slack.com/services/new/bot and put the token
  name: "yelphelp"
};
...
var authreq = {
  ...
  client_id: "LZePfZIBi3_pSNP_EbtWxw", // put the App ID here,
  client_secret:
    "ADxgKYNDdySTGd2HMNeiv9Fl6p4y2EyO2Qj8JRBW3scKnaDcUVsVItmOTl0xcIFp" // put the App secret here
};
